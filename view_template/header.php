<header>
  ...
  <section class="header-section search-section">
    <form action="" class="header-forms">
      <input type="text" autocomplete="off" name="search" class="input" placeholder="Search">
      <input type="submit" value="Search" class="header-btn">
    </form>
  </section>
  <section class="header-section btn-section">
